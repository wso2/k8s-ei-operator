...
func (r *ReconcileIntegration) ingressForIntegration(m *integrationv1alpha1.Integration, eic *EIController) *v1beta1.Ingress {
...
func (r *ReconcileIntegration) updateIngressForIntegration(m *integrationv1alpha1.Integration, eic *EIController, currentIngress *v1beta1.Ingress) *v1beta1.Ingress {
